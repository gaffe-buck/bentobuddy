...
def export_dae(matrices=None, joint='bone_data', file=None, real=None):
    ...
    dae_apply_modifiers_type = "render"
    if bb_devkit.dae_export_mesh_type_selection == True:
        dae_apply_modifiers_type = "view"

    bpy.ops.wm.collada_export(
        filepath = file_path,
        check_existing = False,
        apply_modifiers = bb_devkit.dae_apply_modifiers,
        export_mesh_type_selection=dae_apply_modifiers_type,
        selected = True,
